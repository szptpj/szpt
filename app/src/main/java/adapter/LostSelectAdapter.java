...
public class LostSelectAdapter extends BaseAdapter {
    ...
    public LostSelectAdapter(Context context, List<String> list) {
    ...
    static class ViewHolder {
        ...
        ViewHolder(View view) {
           mText= (TextView) view.findViewById(R.id.shuaixuan_text);
        }
    }
}
